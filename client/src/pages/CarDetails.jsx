    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        <div className='lg:col-span-2'>
          <img src={car.image} alt='image' className='w-full h-auto md:mask-x-to-fuchsia-100 object-cover rounded-xl mb-6 shadow-md' />
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
              {[
                ...
                <div key={text} className='flex flex-col items-center bg-light p-4 rounded-lg'>
                  <img src={icon.icon} alt='icon' className='h-5 mb-2' />
                  {icon.text}
                </div>
              ))}
            </div>
        ...
        <form onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
          ...
          <p className='text-center text-sm'>No credit card required to resurve</p>
